...
# https://journals.physiology.org/doi/full/10.1152/physiolgenomics.00084.2020
...
def train_model_2(model, n_epoch, labelsdict, criterion, optimizer, device, trainloader, validloader, train_data, model_name, model_path, model_path_best, loss_graph, accuracy_graph, start_epoch = 0, valid_loss = 1000):
    """
    ...
    print(f'Training custom CNN Model to distinguish infected covid and infected non covid lungs')
